...
1. [Project Overview and Team Info 👥](#1-project-overview-and-team-info-)
2. [Dataset Source and Description 📊](#2-dataset-source-and-description-)
...
```bash
git clone https://github.com/LeMinhNhat2901/football_data_transfermark_eda.git
cd Football_data_transfermark_eda
```

### 6.2: Create Virtual Environment (Recommended) 🧪

Nếu bạn muốn làm việc với môi trường conda (Bạn có thể chọn phiên bản Python khác (>=3.8))
```bash
conda create -n football_eda python=3.10.16 
conda activate football_eda
```

Hoặc bạn có thể làm cách này (dùng môi trường ảo)
```bash
python -m venv venv
...
Chạy từng file notebook với quy trình thực hiện dự án được triển khai theo thứ tự các notebook sau:
...
* **Others:** `jupyter`, `ipykernel`

Chi tiết đầy đủ xem trong file `requirement.txt`

---

## 8. Contact & Contribution 📧

Nếu bạn có bất kỳ câu hỏi hoặc đóng góp nào, vui lòng liên hệ qua:
...
* **Course Name:** Lập trình cho Khoa học dữ liệu (Thực hành 02)
* **Department:** Khoa Công nghệ Thông tin, Trường Đại học Khoa học Tự nhiên (ĐHQG-HCM)
* **Academic Year:** 2025-2026

### Instructors

* **Lê Nhựt Nam** - <lnnam@fit.hcmus.edu.vn>
* **Nguyễn Thanh Tình** - <nttinh@fit.hcmus.edu.vn>
* **Phạm Trọng Nghĩa**  - <ptnghia@fit.hcmus.edu.vn>

### Academic Integrity Commitment

Đồ án này tuân thủ các tiêu chuẩn cao nhất về tính liêm chính trong học thuật:

* Toàn bộ mã nguồn là sản phẩm gốc hoặc có trích dẫn nguồn đầy đủ.
* Các tài liệu tham khảo, thư viện và tài nguyên bên ngoài đều được ghi nhận rõ ràng.
* Việc hợp tác chỉ giới hạn trong các buổi thảo luận và làm việc nhóm được môn học cho phép.
* Không có hành vi đạo văn hay chia sẻ mã nguồn trái phép.

### Support and Questions

Đối với các câu hỏi liên quan đến môn học hoặc hỗ trợ kỹ thuật:

* **Primary Channel:** Sử dụng nhóm ZALO của môn học.
* **Office Hours:** Theo thông báo của giảng viên.
* **Project Issues:** Liên hệ trưởng nhóm qua email hoặc GitHub.
